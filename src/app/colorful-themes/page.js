...
const page = () => {
  ...
  return (
    <div className='relative flex justify-around'>
      ...
      <div className='flex flex-col px-4 gap-2 h-screen py-4 overflow-y-auto'>
      ...
      <form onSubmit={saveTheme} className='flex justify-center items-center flex-col gap-4 h-screen'>
        <h1>Titel</h1>
