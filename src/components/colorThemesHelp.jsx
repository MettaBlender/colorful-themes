...
const ColorThemesHelp = ({className}) => {
  return (
    <div className={`fixed h-10 w-auto aspect-square right-2 bottom-2 z-40 bg-background-secondary rounded-full ${className}`}>
      <Link href="/colorful-themes/docs" className="flex items-center justify-center h-full w-full text-foreground-secondary hover:text-foreground transition-colors">
